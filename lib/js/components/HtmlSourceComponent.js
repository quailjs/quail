...
var HtmlSourceComponent = {
  ...
  traverse: function traverse(parsed, callback, number, alreadyCalled) {
    var that = this;
  ...
  addSelector: function addSelector(element, childNumber, parent) {
...
module.exports = HtmlSourceComponent;