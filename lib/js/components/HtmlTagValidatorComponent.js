...
var htmlTagValidator = function htmlTagValidator() {
  ...
  var ignoreWithin = ['pre', 'code', 'textarea', 'script', 'style'];

  var optionalClosing = ['p', 'li', 'tr', 'th', 'td'];

  var tagObject = function tagObject(lIndex, cIndex) {
    return { name: currentTagName, line: lIndex + 1, char: cIndex };
  };

  var throwEndingTagError = function throwEndingTagError(tagObj) {
  ...
  var throwEndingCommentError = function throwEndingCommentError(commentObj) {
  ...
  var throwSelfClosingFormatError = function throwSelfClosingFormatError(tagObj) {
  ...
  var setParserFunc = function setParserFunc(func) {
    previousParserFunc = parserFunc;
    parserFunc = func;
  };

  var goBackNumChars = function goBackNumChars(num) {
    characterIndex -= num;
  };
  ...
  var checkTags = function checkTags(string, opts) {
...
var HtmlTagValidatorComponent = htmlTagValidator();
module.exports = HtmlTagValidatorComponent;