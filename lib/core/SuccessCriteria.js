...
var SuccessCriteria = (function () {
  ...
  SuccessCriteria.fn = SuccessCriteria.prototype = {
     ...
     */
    registerTests: function registerTests(testCollection) {
     ...
     */
    filterTests: function filterTests(tests) {
     ...
     */
    addConclusion: function addConclusion(conclusion, _case) {
     ...
     */
    evaluate: function evaluate(eventName, testCollection) {
