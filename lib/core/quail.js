...
Function.prototype.bind = Function.prototype.bind || function (b) {
  ...
  var C = function C() {};
  var d = function d() {
    return self.apply(this instanceof C ? this : b || window, f.concat(a.call(arguments)));
  };
...
var quail = {
   ...
   */
  textSelector: ['tt', 'i', 'b', 'big', 'small', 'em', 'strong', 'dfn', 'code', 'samp', 'kbd', 'var', 'cite', 'abbr', 'acronym', 'sub', 'sup', 'span', 'bdo', 'address', 'div', 'a', 'object', 'p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'pre', 'q', 'ins', 'del', 'dt', 'dd', 'li', 'label', 'option', 'textarea', 'fieldset', 'legend', 'button', 'caption', 'td', 'th'].join(', '),
   ...
   */
  focusElements: ['a[href]', 'area[href]', 'input:not([disabled])', 'select:not([disabled])', 'textarea:not([disabled])', 'button:not([disabled])', 'iframe', 'object', 'embed', '*[tabindex]', '*[contenteditable]'].join(', '),
   ...
   * phonetic tests.
   */
  isUnreadable: function isUnreadable(text) {
   ...
   */
  isDataTable: function isDataTable(table) {
   ...
   */
  getTextContents: function getTextContents($element) {
  ...
  containsReadableText: function containsReadableText(element, children) {
