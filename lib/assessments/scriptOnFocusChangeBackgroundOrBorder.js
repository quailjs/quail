...
var ScriptOnFocusChangeBackgroundOrBorder = function ScriptOnFocusChangeBackgroundOrBorder(quail, test, Case) {
  var buildCase = function buildCase(element, status, id, message) {
    test.add(Case({
      element: element,
      message: message,
      status: status
