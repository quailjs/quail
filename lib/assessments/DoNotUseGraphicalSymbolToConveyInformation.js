...
var DoNotUseGraphicalSymbolToConveyInformation = function DoNotUseGraphicalSymbolToConveyInformation(quail, test) {
  // Passes and fails.
  ...
  // Not applicables.
  test.get('$scope').find(TextSelectorComponent).filter('abbr, acronym').filter(function (index, element) {
