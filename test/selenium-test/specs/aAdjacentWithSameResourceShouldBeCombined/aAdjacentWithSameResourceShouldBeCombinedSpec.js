describe('assessment: aAdjacentWithSameResourceShouldBeCombined', function () {
  ...
  it('should return the proper assessment for the test', function () {
    expect(quailResults.tests['aAdjacentWithSameResourceShouldBeCombined'].cases).to.deep.equal([{
      ...
      "status": "failed",
      "selector": "a[href=\"products.html\"].quail-failed-element",
      "html": "<a href=\"products.html\" class=\"quail-failed-element\"><img src=\"../assets/go.gif\" alt=\"\"></a>"},
    {
      "status": "failed",
      "selector": "a[href=\"products.html\"].quail-failed-element",
      "html": "<a href=\"products.html\" class=\"quail-failed-element\"><img src=\"../assets/go.gif\" alt=\"Products page\"></a>"
    }]);
  });
});
