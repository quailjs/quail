describe('assessment: colorElementBehindBackgroundGradientContrast', function () {
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['colorElementBehindBackgroundGradientContrast'].cases;
