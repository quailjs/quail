describe('assessment: inputRadioHasTabIndex', function () {
  ...
  before('load webdrivers and run evaluations with Quail', function () {
    return quailTestRunner.setup({
        url: 'http://localhost:9999/inputRadioHasTabIndex/inputRadioHasTabIndex.html',
        assessments: [
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['inputRadioHasTabIndex'].cases;
