describe('assessment: headersUsedToIndicateMainContent', function () {
  ...
  before('load webdrivers and run evaluations with Quail', function () {
    return quailTestRunner.setup({
        url: 'http://localhost:9999/headersUsedToIndicateMainContent/headersUsedToIndicateMainContent.html',
        assessments: [
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['headersUsedToIndicateMainContent'].cases;
