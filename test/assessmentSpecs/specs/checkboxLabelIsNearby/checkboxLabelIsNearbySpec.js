describe('assessment: checkboxLabelIsNearby', function () {
  ...
  before('load webdrivers and run evaluations with Quail', function () {
    return quailTestRunner.setup({
        url: 'http://localhost:9999/checkboxLabelIsNearby/checkboxLabelIsNearby.html',
        assessments: [
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['checkboxLabelIsNearby'].cases;
