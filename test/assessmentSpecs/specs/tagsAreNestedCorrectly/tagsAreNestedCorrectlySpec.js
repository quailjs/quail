describe('assessment: tagsAreNestedCorrectly', function () {
  ...
  before('load webdrivers and run evaluations with Quail', function () {
    return quailTestRunner.setup({
        url: 'http://localhost:9999/tagsAreNestedCorrectly/tagsAreNestedCorrectly.html',
        assessments: [
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['tagsAreNestedCorrectly'].cases;
