describe('assessment: domOrderMatchesVisualOrder', function () {
  ...
  describe('the non-match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/domOrderMatchesVisualOrder/domOrderMatchesVisualOrder-nomatch.html',
          assessments: [
  ...
  describe('the match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/domOrderMatchesVisualOrder/domOrderMatchesVisualOrder.html',
          assessments: [
            'domOrderMatchesVisualOrder'
          ]
        })
