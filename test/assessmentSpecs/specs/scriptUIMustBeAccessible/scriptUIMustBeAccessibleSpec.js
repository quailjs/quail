describe('assessment: scriptUIMustBeAccessible', function () {
  ...
  describe('the non-match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/scriptUIMustBeAccessible/scriptUIMustBeAccessible-nomatch.html',
          assessments: [
        ...
        .spread(function (_client_, _assessments_, _quailResults_) {
          ...
          cases = quailResults.tests.scriptUIMustBeAccessible.cases;
        });
    });
    ...
    it('should have correct key under the test results', function () {
      expect(quailResults.tests).to.include.keys('scriptUIMustBeAccessible');
    });
  ...
  describe('the match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/scriptUIMustBeAccessible/scriptUIMustBeAccessible.html',
          assessments: [
            'scriptUIMustBeAccessible'
          ]
        })
