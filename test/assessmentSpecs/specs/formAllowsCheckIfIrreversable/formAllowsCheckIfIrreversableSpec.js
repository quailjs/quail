describe('assessment: formAllowsCheckIfIrreversable', function () {
  ...
  describe('the non-match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/formAllowsCheckIfIrreversable/formAllowsCheckIfIrreversable-nomatch.html',
          assessments: [
    ...
    it('should have correct key under the test results', function () {
      expect(quailResults.tests).to.include.keys('formAllowsCheckIfIrreversable');
    });
  ...
  describe('the match case', function () {
    before('load webdrivers and run evaluations with Quail', function () {
      return quailTestRunner.setup({
          url: 'http://localhost:9999/formAllowsCheckIfIrreversable/formAllowsCheckIfIrreversable.html',
          assessments: [
            'formAllowsCheckIfIrreversable'
          ]
        })
