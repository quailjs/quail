describe('assessment: emoticonsMissingAbbr', function () {
  ...
  before('load webdrivers and run evaluations with Quail', function () {
    return quailTestRunner.setup({
        url: 'http://localhost:9999/emoticonsMissingAbbr/emoticonsMissingAbbr.html',
        assessments: [
  ...
  it('should have correct key under the test results', function () {
    expect(quailResults.tests).to.include.keys('emoticonsMissingAbbr');
  });

  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['emoticonsMissingAbbr'].cases;
