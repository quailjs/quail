describe('assessment: scriptContentAccessibleWithScriptsTurnedOff', function () {
  ...
  it('should return the proper assessment for the test', function () {
    var cases = quailResults.tests['scriptContentAccessibleWithScriptsTurnedOff'].cases;
